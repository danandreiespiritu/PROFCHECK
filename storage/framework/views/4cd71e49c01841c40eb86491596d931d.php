...
<body class="bg-gradient-to-br from-blue-50 to-blue-100 min-h-screen">
    ...
    <div class="flex flex-col items-center justify-center min-h-[80vh] px-4">
        <?php if(! $faculty): ?>
            <div class="bg-white rounded-2xl shadow-lg p-8 max-w-md w-full mt-10">
                ...
                <a href="<?php echo e(route('profile.edit')); ?>" class="w-full block text-center px-4 py-2 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition">Complete Profile</a>
            </div>
        <?php else: ?>
            <div class="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-3 gap-8 mt-10">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center">
                    <img src="<?php echo e(asset('storage/images/university-student6136.logowik.jpeg')); ?>" alt="avatar" class="w-28 h-28 rounded-full object-cover border-4 border-blue-200 shadow mb-4">
                    <h2 class="text-2xl font-bold text-gray-800 mb-1"><?php echo e($faculty->FirstName); ?> <?php echo e($faculty->LastName); ?></h2>
                    <div class="text-blue-600 font-semibold mb-2"><?php echo e($faculty->Position); ?></div>
                    <div class="w-full mt-4 space-y-2 text-sm text-gray-600">
                        <div class="flex items-center"><span class="font-semibold w-20">Email:</span> <span class="truncate"><?php echo e($faculty->Email); ?></span></div>
                        <div class="flex items-center"><span class="font-semibold w-20">RFID:</span> <span><?php echo e($faculty->rfid_tag); ?></span></div>
                    </div>
                </div>
                <!-- Dashboard Card -->
                <div class="bg-white rounded-2xl shadow-lg p-8 lg:col-span-2 flex flex-col justify-center">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="<?php echo e(route('faculty.attendance.logs')); ?>" class="flex-1 px-4 py-3 bg-blue-600 text-white rounded-lg font-semibold text-center hover:bg-blue-700 transition">View Attendance Logs</a>
                        <a href="<?php echo e(route('profile.edit')); ?>" class="flex-1 px-4 py-3 bg-green-600 text-white rounded-lg font-semibold text-center hover:bg-green-700 transition">Edit Profile</a>
                    </div>
                </div>
            </div>
        <?php endif; ?>
    ...
    <div class="md:hidden fixed bottom-0 left-0 right-0 bg-white shadow-inner z-50">
        <div class="flex justify-around py-2">
            <a href="<?php echo e(route('faculty.dashboard')); ?>" class="flex flex-col items-center text-blue-700 hover:text-blue-900 text-xs">
            ...
            <a href="<?php echo e(route('faculty.attendance.logs')); ?>" class="flex flex-col items-center text-blue-700 hover:text-blue-900 text-xs">
            ...
            <a href="<?php echo e(route('profile.edit')); ?>" class="flex flex-col items-center text-blue-700 hover:text-blue-900 text-xs">
...
<?php /**PATH C:\xampp\htdocs\RFIDAttendanceSystem\RFIDAttendanceSystem\resources\views/faculty/profile.blade.php ENDPATH**/ ?>