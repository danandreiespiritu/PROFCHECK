...
<head>
    ...
    <title>Add Faculty - PROFCHECK</title>
    ...
    <main class="p-8 space-y-10 overflow-auto bg-gradient-to-br from-blue-50 via-white to-blue-100 min-h-screen">
        <div class="max-w-4xl mx-auto bg-white p-10 rounded-3xl shadow-2xl border border-blue-100">
            <div class="flex items-center gap-4 mb-10">
                ...
                <h2 class="text-3xl font-extrabold text-blue-900 tracking-tight">Add Faculty</h2>
            </div>

            <form action="<?php echo e(route('admin.manageFaculty.addFacultyStore')); ?>" method="POST" class="space-y-8">
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\RFIDAttendanceSystem\RFIDAttendanceSystem\resources\views/admin/manageFaculty/addFaculty.blade.php ENDPATH**/ ?>