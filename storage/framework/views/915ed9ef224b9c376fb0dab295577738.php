   ...
   <!-- Dashboard content -->
    <main class="p-6 space-y-8 overflow-auto bg-[#f8fafc] min-h-screen">
        <div class="max-w-3xl mx-auto bg-white p-8 rounded-xl shadow-md">
            ...
            <form action="<?php echo e(route('admin.manageClassSchedule.updateClassSchedule', $schedule->id)); ?>" method="POST" class="space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <select name="faculty_ID" id="faculty_ID" class="w-full border border-blue-200 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" required>
                            ...
                            <?php $__currentLoopData = $faculties ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faculty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($faculty->Faculty_ID); ?>"
                                    <?php if(old('faculty_ID', $schedule->faculty_ID) == $faculty->Faculty_ID): ?> selected <?php endif; ?>>
                    ...
                    <div>
                        ...
                        <input value="<?php echo e(old('subject', $schedule->subject)); ?>" type="text" name="subject" id="subject" class="w-full border border-blue-200 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" required>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="section" id="section" class="w-full border border-blue-200 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" required>
                            ...
                            <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($section); ?>" <?php echo e($selectedSection == $section ? 'selected' : ''); ?>><?php echo e($section); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="day_of_week" id="day_of_week" class="w-full border border-blue-200 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" required>
                            ...
                            <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($day); ?>" <?php echo e($selectedDay == $day ? 'selected' : ''); ?>><?php echo e($day); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <!-- Start Time -->
                    <div>
                        ...
                        <input type="time" name="start_time" id="start_time" class="w-full border border-blue-200 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" value="<?php echo e(old('start_time', $schedule->start_time)); ?>" required>
                    </div>

                    <!-- End Time -->
                    <div>
                        <label for="end_time" class="block text-blue-900 font-semibold mb-2">End Time</label>
                        <input type="time" name="end_time" id="end_time" class="w-full border border-blue-200 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" value="<?php echo e(old('end_time', $schedule->end_time)); ?>" required>
                    </div>

                    <!-- Room -->
                    <div>
                        <label for="room" class="block text-blue-900 font-semibold mb-2">Room</label>
                        <input type="text" value="<?php echo e(old('room', $schedule->room)); ?>" name="room" id="room" class="w-full border border-blue-200 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" required>
                    </div>
                </div>
...
</html><?php /**PATH C:\xampp\htdocs\RFIDAttendanceSystem\RFIDAttendanceSystem\resources\views/admin/manageClassSchedule/editClassSched.blade.php ENDPATH**/ ?>