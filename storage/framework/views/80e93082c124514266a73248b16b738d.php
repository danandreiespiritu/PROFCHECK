        ...
        <main class="p-6 space-y-8 overflow-auto bg-gradient-to-br from-blue-50 via-white to-blue-100 min-h-screen">
            <div class="max-w-screen mx-auto bg-white p-10 rounded-3xl shadow-2xl border border-blue-200">
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-10 gap-4">
                    ...
                    <a href="<?php echo e(url('admin/manageClassSchedule/addClassSched')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-xl shadow hover:from-blue-700 hover:to-blue-600 transition text-base font-semibold">
                        <i class="fas fa-plus"></i> Add Schedule
                    </a>
                </div>

                <?php $__empty_1 = true; $__currentLoopData = $groupedSchedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facultyName => $schedules): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <section class="mb-14">
                    <div class="flex items-center gap-4 mb-5">
                        ...
                        <h3 class="text-2xl font-semibold text-blue-700"><?php echo e($facultyName); ?></h3>
                    </div>
                        ...
                        <table class="min-w-full bg-transparent divide-y divide-blue-100">
                            ...
                            <tbody class="divide-y divide-blue-50">
                                ...
                                <tr class="hover:bg-blue-50 transition">
                                    <td class="py-3 px-6"><?php echo e($schedule->subject); ?></td>
                                    <td class="py-3 px-6"><?php echo e($schedule->section); ?></td>
                                    <td class="py-3 px-6"><?php echo e($schedule->Yearlvl); ?></td>
                                    <td class="py-3 px-6">
                                    ...
                                    <td class="py-3 px-6">
                                        <div class="flex items-center gap-2">
                                            <a href="<?php echo e(url('admin/manageClassSchedule/editClassSched/' . $schedule->id)); ?>" class="text-blue-600 hover:text-blue-800 p-2 rounded-full hover:bg-blue-100 transition" title="Edit">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <!-- Delete Button (Triggers Modal) -->
                                            <button type="button"
                                                    class="text-red-600 hover:text-red-800 p-2 rounded-full hover:bg-red-100 transition"
                                                    onclick="openDeleteModal('<?php echo e($schedule->id); ?>')"
                                                    title="Delete">
                                                <i class="fas fa-trash-alt"></i>
                                            </button>

                                            <!-- Delete Modal -->
                                            <div id="deleteModal-<?php echo e($schedule->id); ?>" class="fixed inset-0 flex items-center justify-center z-50 hidden">
                                                ...
                                                <div class="relative bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full space-y-6 border border-blue-100 animate-fade-in">
                                                    ...
                                                    <div class="flex justify-end gap-3 pt-2">
                                                        <button type="button"
                                                                onclick="closeDeleteModal('<?php echo e($schedule->id); ?>')"
                                                        ...
                                                        <form action="<?php echo e(route('admin.manageClassSchedule.deleteClassSchedule', $schedule->id)); ?>" method="POST">
                                                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\RFIDAttendanceSystem\RFIDAttendanceSystem\resources\views/admin/manageClassSchedule/viewClassSched.blade.php ENDPATH**/ ?>