...
<body class="min-h-screen flex flex-col font-sans dark:text-gray-100">
    <header class="w-full bg-white/80 dark:bg-slate-800/80 shadow sticky top-0 z-20 backdrop-blur">
        <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            <div class="flex items-center gap-3">
                <img src="<?php echo e(asset('storage/images/ravinallogo.jpg')); ?>" alt="logo" class="w-10 h-10 rounded-full object-cover">
                <div>
            ...
            <div class="flex items-center gap-4">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="px-4 py-2 text-sm rounded-md bg-blue-600 text-white">Dashboard</a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="px-4 py-2 text-sm rounded-md text-blue-700 border border-blue-100 hover:bg-blue-50">Log in</a>
                    <?php if(Route::has('register')): ?>
                        <a href="<?php echo e(route('register')); ?>" class="px-4 py-2 text-sm rounded-md bg-blue-600 text-white">Register</a>
                    <?php endif; ?>
                <?php endif; ?>
        ...
        <section class="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
                ...
                <div class="mt-8 flex flex-wrap gap-4">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="px-5 py-3 rounded-md bg-blue-600 text-white shadow hover:bg-blue-700">Get started</a>
                    <?php if(Route::has('register')): ?>
                        <a href="<?php echo e(route('register')); ?>" class="px-5 py-3 rounded-md bg-white text-blue-600 border border-blue-100 hover:bg-blue-50">Create account</a>
                    <?php endif; ?>
                    <?php else: ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="px-5 py-3 rounded-md bg-blue-600 text-white shadow hover:bg-blue-700">Open dashboard</a>
                    <?php endif; ?>
            ...
            <div class="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="text-3xl font-bold text-blue-700 dark:text-blue-300 mt-1"><?php echo e(\App\Models\Attendance::whereDate('date', now()->toDateString())->count() ?? 0); ?></div>
                ...
                <div class="mt-6 grid grid-cols-2 gap-4 text-sm text-gray-600 dark:text-gray-300">
                    <div class="p-3 bg-gray-50 dark:bg-slate-700 rounded">
                        ...
                        <div class="text-xl font-semibold"><?php echo e(\App\Models\Faculty::count()); ?></div>
                    </div>
                    <div class="p-3 bg-gray-50 dark:bg-slate-700 rounded">
                        <div class="font-medium">Schedules</div>
                        <div class="text-xl font-semibold"><?php echo e(\App\Models\ClassSchedule::count()); ?></div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="max-w-7xl mx-auto px-6 py-12">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
                ...
                <div class="p-6 bg-white dark:bg-slate-800 rounded-lg shadow">
                    ...
                    <div class="mt-4">
                        <?php if(auth()->guard()->guest()): ?>
                        <a href="<?php echo e(route('register')); ?>" class="block text-center px-4 py-2 rounded-md bg-blue-600 text-white">Register</a>
                        <a href="<?php echo e(route('login')); ?>" class="block mt-3 text-center px-4 py-2 rounded-md bg-white text-blue-600 border border-blue-100">Log in</a>
                        <?php else: ?>
                        <a href="<?php echo e(route('dashboard')); ?>" class="block text-center px-4 py-2 rounded-md bg-blue-600 text-white">Open dashboard</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
    ...
    <footer class="mt-16 border-t border-blue-100 dark:border-slate-700 pt-8 text-gray-500 dark:text-gray-400 text-sm w-full">
        <div class="max-w-7xl mx-auto px-6 py-6 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
                ...
                <ul class="mt-2 space-y-1">
                    <li><a href="<?php echo e(route('login')); ?>" class="hover:underline">Login</a></li>
                    <?php if(Route::has('register')): ?><li><a href="<?php echo e(route('register')); ?>" class="hover:underline">Register</a></li><?php endif; ?>
                    <li><a href="<?php echo e(url('/contact')); ?>" class="hover:underline">Contact</a></li>
                </ul>
            </div>
            <div>
        ...
        <div class="text-center py-4 text-xs text-gray-400">&copy; <?php echo e(date('Y')); ?> PROFCHECK. All rights reserved.</div>
    </footer>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\RFIDAttendanceSystem\RFIDAttendanceSystem\resources\views/guestDashboard.blade.php ENDPATH**/ ?>