 ...
 <body x-data="{ sidebarOpen: true }" class="bg-[#f0f5f8] min-h-screen flex">
   ...
   <!-- Dashboard content -->
    <main class="p-6 space-y-8 overflow-auto bg-[#f8fafc] min-h-screen">
        <div class="max-w-screen mx-auto bg-white p-10 rounded-2xl shadow-xl border border-blue-100">
            <div class="flex items-center justify-between mb-8">
                <h2 class="text-2xl font-extrabold text-blue-800 flex items-center gap-2">
                    ...
                    Attendance Records for <?php echo e(\Carbon\Carbon::now('Asia/Manila')->format('F d, Y')); ?>

                </h2>
                <a href="<?php echo e(url()->current()); ?>" class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg shadow hover:bg-blue-700 transition text-sm font-semibold">
            ...
            <div class="overflow-x-auto rounded-lg border border-blue-50">
                ...
                <div id="vue-attendance-root"
                     data-poll-url="<?php echo e(route('admin.attendance.rows')); ?>"
                     data-initial-rows='<?php echo json_encode($initialRows, 15, 512) ?>'>
                ...
                <table class="min-w-full divide-y divide-blue-100 text-sm">
                    ...
                    <tbody class="divide-y divide-blue-50 bg-white">
                        ...
                        <tr class="hover:bg-blue-50 transition">
                            ...
                            <td class="px-4 py-3 text-blue-900">
                                <?php echo e($attendance->classSchedule->subject ?? 'N/A'); ?>
        ...
        <input type="hidden" id="attendance-count" value="<?php echo e($attendances->count()); ?>">
    <!-- Poll endpoint URL used by Vue component (and legacy polling) -->
    <input type="hidden" id="attendance-poll-url" value="<?php echo e(route('admin.attendance.rows')); ?>">
    </main>
  </div>
 </body>
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const pollUrl = document.getElementById('attendance-poll-url')?.value || "<?php echo e(url('admin/attendance/dailyAttendance/count')); ?>";
...
</html><?php /**PATH C:\xampp\htdocs\RFIDAttendanceSystem\RFIDAttendanceSystem\resources\views/admin/attendance/dailyAttendance.blade.php ENDPATH**/ ?>